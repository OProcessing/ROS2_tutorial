...
#ifndef MY_FIRST_PACKAGE_MSGS__MSG__CMD_AND_POSE_VEL_H_
#define MY_FIRST_PACKAGE_MSGS__MSG__CMD_AND_POSE_VEL_H_
...
#endif  // MY_FIRST_PACKAGE_MSGS__MSG__CMD_AND_POSE_VEL_H_
