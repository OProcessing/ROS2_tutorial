...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'oneday_set_flag = my_first_package.oneday_set_flag:main',
            'oneday_subscriber = my_first_package.oneday_subscriber:main',
            'oneday_pen = my_first_package.oneday_pen:main',
        ],
    },
)
